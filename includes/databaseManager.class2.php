...
class DatabaseManager {
    ...
    public function getTodayYesterdayDataBG($sid){
        $sql = "
            SELECT * FROM tiktok_records_bulgaria 
            WHERE DATE(`fetch_date`) >= ADDDATE(DATE(CURRENT_TIMESTAMP()), INTERVAL -1 DAY) 
            AND song_id=:sth
        ";
    ...
    public function getSongDataBG($sid){
        $sql = "SELECT * FROM `tiktok_songs_bulgaria`
                WHERE id=:mandja";
    ...
    public function listTop200SongsBG() {
        $sql = "SELECT * FROM `tiktok_records_bulgaria` 
                JOIN tiktok_songs_bulgaria ON tiktok_records_bulgaria.song_id = tiktok_songs_bulgaria.id
                WHERE DATE(`fetch_date`) = DATE(NOW())";
    ...
    public function listTop50songs() {
        $sql = "SELECT * FROM `tiktok_records` 
                JOIN tiktok_songs ON tiktok_records.song_id = tiktok_songs.id
    ...
    public function findSongByTiktokIdBG($pesho){
        $sql = "SELECT * FROM tiktok_songs_bulgaria WHERE `tiktok_platform_id`=:nababatifurchiloto";
    ...
    public function createSongGlobal($object){
        $sql = "
    ...
    public function createSongBG($object){
        $sql = "
            INSERT INTO `tiktok_songs_bulgaria` ( 
                `song_name`, 
                `artist_name`,
                `tiktok_platform_id`,
                `spotify_platform_id`, 
 ...
 //    // ------------------ Authentication --------------------------
    ...
    public function getTiktokersTodayData(){
        $sql = "SELECT * FROM `tiktokers` WHERE DATE(`fetch_date`) = DATE(NOW())";
    ...
    public function getTopVideosTodayData(){
        $sql = "SELECT * FROM `tiktok_top_videos` WHERE DATE(`fetch_date`) = DATE(NOW())";
