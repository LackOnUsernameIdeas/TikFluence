...
class DatabaseManager {
    ...
    //Дърпаме информацията за топ 200 песни и за днес и за вчера
    ...
    //Взимаме данни за топ 50 песни(за България)
    ...
    //Взимаме информация за потребителя
    /**
     * @return false|array
     */
