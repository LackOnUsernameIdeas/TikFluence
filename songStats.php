...
<body class="theme-purple">
                        ...
                        <div class="block-header">
                            <div class="card">
                                <div class="body">
                                    ...
                                    <?php endif;?>
                                    <i class="material-icons" data-toggle="modal" data-target="#defaultModal" style="cursor: pointer;display: inline-block;vertical-align: middle;">info_outline</i>
                                    <div class="info"> 
    ...
    // Линейни статистики
        ...
        const ttDataAvg = JSON.parse('<?php echo json_encode($averageTT) ?>');
        ...
        if(ytDataNulls.length != ytDataNums.length){
            ...
            const ytDataAvg = JSON.parse('<?php echo json_encode($averageYT) ?>');
        ...
        if(syDataNulls.length != syDataNums.length){
            ...
            const syDataAvg = JSON.parse('<?php echo json_encode($averageSY) ?>');
