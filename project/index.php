        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="body">
                    ...
                    <div class="block-header card p-t-10 p-l-10 p-r-10">
                        ...
                        <ol class="breadcrumb breadcrumb-col-black">
                            <li class="active"><a href="javascript:void(0);"><i class="material-icons">home</i>НАЧАЛО</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="pages/individualStats.php">
                            <i class="material-icons">person_outline</i>
                            <span>СТАТИСТИКИ ЗА ПОТРЕБИТЕЛЯ</span>
                        </a>
                    </li>
                    <li>
                        <a href="pages/additionalStats.php">
